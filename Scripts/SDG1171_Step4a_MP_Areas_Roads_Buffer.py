...
def process(iso):
    ...
    if message is None:
        try:
            ...
            #arcpy.Delete_management(buffered_roads)
            arcpy.PairwiseBuffer_analysis(out_roads, buffered_roads, '%s kilometers' % median_width_km,"NONE","#","GEODESIC")
            message = 'Done: ' + iso
